...
<body>
    ...
    <div class="table-responsive">
        ...
        <?php
            ...
            $num = mysqli_num_rows($result);    // Find the number of records returned
            if($num> 0)             // Display the rows returned by the sql query
            {
                while($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo "<td ><a href='details.php?user={$row["user_name"]}&message=no' type='button' name='user' 
                           id='users1'>Transfer now</a></td>";
                    echo "</tr>";
                }
                echo "</tbody></table>";
            }
